...
describe('mobile OTA release governor', () => {
  ...
  it('covers every shipped or submitted native runtime, including runtimes the pins moved away from', () => {
    ...
    const currentPins = { android: '30', ios: '30' };
  ...
  it('dry-runs beta publish and exact-group production operations with pinned EAS CLI', () => {
    ...
    expect(targetPublishes[11]).toContain('EXPO_RUNTIME_OVERRIDE=30');
    expect(targetPublishes[11]).toContain('--platform ios');
    expect(publish.stdout).toContain(
      'release_plan_targets=android@30,android@23,android@24,android@25,android@26,android@28,ios@23,ios@24,ios@25,ios@26,ios@27,ios@30',
    );
...
`,
    ...
    expect(ledger).toMatchObject({
      ...
      candidateGroupId:
        'candidate-android-30,candidate-android-23,candidate-android-24,candidate-android-25,candidate-android-26,candidate-android-28,candidate-ios-23,candidate-ios-24,candidate-ios-25,candidate-ios-26,candidate-ios-27,candidate-ios-30',
      ...
      production: {
        sourceGroupId:
          'candidate-android-30,candidate-android-23,candidate-android-24,candidate-android-25,candidate-android-26,candidate-android-28,candidate-ios-23,candidate-ios-24,candidate-ios-25,candidate-ios-26,candidate-ios-27,candidate-ios-30',
        groupId:
          'production-android-30,production-android-23,production-android-24,production-android-25,production-android-26,production-android-28,production-ios-23,production-ios-24,production-ios-25,production-ios-26,production-ios-27,production-ios-30',
        targets: [
...
`,
    ...
    expect(JSON.parse(readFileSync(ledgerPath, 'utf8'))).toMatchObject({
      ...
      runtimeVersions: ['30', '23', '24', '25', '26', '28', '27'],
    });
    ...
    expect(republished[11]).toContain('--group candidate-ios-30');
    ...
    expect(JSON.parse(readFileSync(ledgerPath, 'utf8'))).toMatchObject({
      ...
      production: {
        ...
        groupId:
          'production-android-30,production-android-23,production-android,production-android-25,production-android-26,production-android-28,production-ios-23,production-ios-24,production-ios-25,production-ios-26,production-ios-27,production-ios-30',
      },
    });
    ...
    expect(proof.stdout).toContain(
      'production_group_id=production-android-30,production-android-23,production-android,production-android-25,production-android-26,production-android-28,production-ios-23,production-ios-24,production-ios-25,production-ios-26,production-ios-27,production-ios-30',
    );
    expect(proof.stdout).toContain(
      'release_targets=android@30,android@23,android@24,android@25,android@26,android@28,ios@23,ios@24,ios@25,ios@26,ios@27,ios@30',
    );
    expect(proof.stdout).toContain(
      'production_groups=android=production-android-30,ios=production-ios-30',
    );
    expect(proof.stdout).toContain(
      'production_targets=android@30,android@23,android@24,android@25,android@26,android@28,ios@23,ios@24,ios@25,ios@26,ios@27,ios@30',
    );
        ...
        devices: [
          {
            ...
            group: 'production-android-30',
            updateId: 'prod-next-android-30',
    ...
    expect(target.stdout.split('\n')[0]).toBe(
      'group_id=production-android-30,production-android-23,production-android,production-android-25,production-android-26,production-android-28,production-ios-23,production-ios-24,production-ios-25,production-ios-26,production-ios-27,production-ios-30',
    );
    expect(
      runRelease([
        'confirm',
        ...
        'production-android-30,production-android-23,production-android,production-android-25,production-android-26,production-android-28,production-ios-23,production-ios-24,production-ios-25,production-ios-26,production-ios-27,production-ios-30',
        '--update-ids',
        'prod-next-android-30,prod-next-android-23,prod-next-android,prod-next-android-25,prod-next-android-26,prod-next-android-28,prod-next-ios-23,prod-next-ios-24,prod-next-ios-25,prod-next-ios-26,prod-next-ios-27,prod-next-ios-30',
      ]).status,
    ).toBe(0);
    expect(JSON.parse(readFileSync(indexPath, 'utf8')).merges.at(-1)).toMatchObject({
      state: 'confirmed',
      confirmed: {
        groupId: 'production-android-30',
        groupIds: [
          'production-android-30',
          'production-android-23',
          'production-android',
...
`,
  ...
  it('reads a page large enough for every release target, so a full promotion never fails its own read-back', () => {
    ...
    const ledgerPath = join(directory, 'ledger.json');
    const targets = [
      ...['23', '24', '25', '26', '28', '30'].map((runtimeVersion) => ({
        platform: 'android',
        runtimeVersion,
      })),
      ...['23', '24', '25', '26', '27', '30'].map((runtimeVersion) => ({
        platform: 'ios',
        runtimeVersion,
      })),
    ];
