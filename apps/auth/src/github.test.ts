...
it('reads merged PR evidence needed to recover a missed webhook', async () => {
  ...
  await expect(app.readPullRequest('room-token', 'owner/widgets', 42)).resolves.toMatchObject({
    number: 42,
    headSha: sha,
