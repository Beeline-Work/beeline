...
- `install-fallback.png` shows the no-handler result after the `buzzy://` launch heuristic expires;
...
- Android accepted the unchanged deep link and dispatched it to
  `app.buzzy.mobile/.MainActivity` with `Status: ok`.
