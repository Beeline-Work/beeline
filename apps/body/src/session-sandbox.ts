...
export const ROOM_READ_ONLY_STEER =
  ...
  'To persist private memory, use beeline-readonly-mcp.write_memory; shell writes to memory are always denied. ' +
 ...
 *    prompt tells the agent to use beeline-readonly-mcp.write_memory.
