...
| workbench-keys-after.png | After: the company mark leads the row, the domains are the quiet line (a hostless key has none), the state word carries its dot, and both heads take 24 |
