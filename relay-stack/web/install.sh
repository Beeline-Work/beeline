...
for path in bin/beeline bin/buzz-agent bin/buzz-dev-mcp bin/beeline-readonly-mcp lib/beeline/beeline-cli.mjs lib/beeline/beeline-readonly-mcp.mjs lib/beeline/pi-mcp-adapter.mjs lib/beeline/bundle.json; do
