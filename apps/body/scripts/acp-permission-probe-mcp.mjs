/**
 * Stub stdio MCP server standing in for `beeline-readonly-mcp`: the same six tool
...
const TOOLS = [
  ...
  {
    name: 'git_log',
    description: 'Local git log',
    inputSchema: { type: 'object', properties: { limit: { type: 'number' } } },
  },
  {
    name: 'git_show',
    description: 'Show a revision',
    inputSchema: { type: 'object', properties: { revision: { type: 'string' } } },
  },
  {
    name: 'git_diff',
    description: 'Diff revisions',
    inputSchema: { type: 'object', properties: { revision: { type: 'string' } } },
  },
];
  ...
  if (msg.method === 'initialize') {
    send({
      ...
      result: {
        ...
        capabilities: { tools: {} },
        serverInfo: { name: 'beeline-readonly-mcp', version: '0.0.0' },
      },
    });
