# Room-list reference mocks

These are screenshots of the first **Previews** study in the phone and desktop
Obsidian HTML mocks supplied for the Room-list v12 review. They are the visual
reference for spacing and row structure, separate from the component proofs in
`../room-list-previews/` and the authenticated app captures in
`../room-list-live-web/`.

The phone mock uses a 24px top and 16px bottom inset around a Room row, a 12px
gap above its author, and a 16px margin below its corner summary. The desktop
