...
The desktop proofs include the persistent 76px Workspace rail. The 1440px
proof uses the 380px default Room list; the 1024px proof uses a 280px Room list.
