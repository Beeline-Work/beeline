...
| Screen | Before | After |
| --- | --- | --- |
| Workbench list | `before-workbench.png` — small stack title `< Workbench`; Google Workspace had no mark | `after-workbench.png` — small **Settings** over large **Workbench**; Google Workspace wears the Keys `ServiceMark` (Google favicon) and the same Connect/connected/soon column as the other tools |
