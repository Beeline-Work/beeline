...
// `@latest`: the current release, never a source-level version pin (captain,
// 2026-09-17). The vault MCP server an agent spawns must match the broker too.
export const SQUIRE_MCP_VERSION = 'latest';
